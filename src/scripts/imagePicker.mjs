class ImagePicker {
  static imageMainSources = [
    '/frontend-mentor-ecommerce-product-page/src/assets/images/image-product-1.jpg',
    '/frontend-mentor-ecommerce-product-page/src/assets/images/image-product-2.jpg',
    '/frontend-mentor-ecommerce-product-page/src/assets/images/image-product-3.jpg',
    '/frontend-mentor-ecommerce-product-page/src/assets/images/image-product-4.jpg',
  ];
